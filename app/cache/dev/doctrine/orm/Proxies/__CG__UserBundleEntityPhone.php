 ...
 */
class Phone extends \UserBundle\Entity\Phone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\Phone' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\Phone' . "\0" . 'number', '' . "\0" . 'UserBundle\\Entity\\Phone' . "\0" . 'customer');
        }
