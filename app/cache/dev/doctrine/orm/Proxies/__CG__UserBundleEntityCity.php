 ...
 */
class City extends \UserBundle\Entity\City implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\City' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\City' . "\0" . 'name', '' . "\0" . 'UserBundle\\Entity\\City' . "\0" . 'zip', '' . "\0" . 'UserBundle\\Entity\\City' . "\0" . 'customer');
        }
