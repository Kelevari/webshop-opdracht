...
use BillingBundle\Entity\Bill;
use BillingBundle\Form\BillType;
...
class BillController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BillingBundle:Bill')->findAll();
     ...
     * @Method("POST")
     * @Template("BillingBundle:Bill:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BillingBundle:Bill')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BillingBundle:Bill:edit.html.twig")
     */
