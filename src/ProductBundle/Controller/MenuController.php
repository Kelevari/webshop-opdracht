...
use ProductBundle\Entity\Menu;
use ProductBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProductBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("ProductBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProductBundle:Menu')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ProductBundle:Menu:edit.html.twig")
     */
