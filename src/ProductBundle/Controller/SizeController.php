...
use ProductBundle\Form\SizeType;
...
class SizeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProductBundle:Size')->findAll();
     ...
     * @Method("POST")
     * @Template("ProductBundle:Size:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProductBundle:Size')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ProductBundle:Size:edit.html.twig")
     */
