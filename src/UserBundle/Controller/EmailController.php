...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:Email')->findAll();
     ...
     * @Method("POST")
     * @Template("UserBundle:Email:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserBundle:Email')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UserBundle:Email:edit.html.twig")
     */
