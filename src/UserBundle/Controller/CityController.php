...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:City')->findAll();
     ...
     * @Method("POST")
     * @Template("UserBundle:City:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserBundle:City')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UserBundle:City:edit.html.twig")
     */
